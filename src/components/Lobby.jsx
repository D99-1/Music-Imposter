        ...
        <div className="flex-1 bg-secondary/5 border border-secondary/10 rounded-[28px] md:rounded-[32px] p-6 md:p-8 space-y-6 md:space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
            {gameState.players.map(p => (
              <div key={p.id} className="flex items-center gap-3 md:gap-4 p-3 md:p-4 bg-primary border border-secondary/5 rounded-2xl group hover:border-highlight/30 transition-all">
        ...
        <div className="w-full lg:w-80 flex flex-col gap-6">
          ...
          {isHost ? (
            <button
              ...
              className="w-full bg-highlight text-white font-black py-6 md:py-8 rounded-[28px] md:rounded-[32px] text-xl md:text-2xl shadow-2xl shadow-highlight/40 hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-30 disabled:scale-100 disabled:shadow-none"
            >
            ...
            <div className="bg-secondary/5 border border-secondary/10 rounded-[28px] md:rounded-[32px] p-6 md:p-8 text-center flex items-center justify-center min-h-[100px] md:min-h-[120px]">
